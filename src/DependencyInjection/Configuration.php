...
use SomeBlackMagic\GuzzleProfilerBundle\PluginInterface;
...
class Configuration implements ConfigurationInterface
{
    ...
    private function createClientsNode() : ArrayNodeDefinition
    {
        ...
        $nodeChildren->scalarNode('class')->defaultValue('%guzzle_profiler.http_client.class%')->end()
                    ->scalarNode('base_url')
                        ->defaultValue(null)
                        ->validate()
                            ->ifTrue(function ($v) {
                                            ...
                                            foreach ($curlOptions as $key => $value) {
                                                ...
                                                if (!defined($optionName)) {
                                                    throw new InvalidConfigurationException(sprintf(
                                                        'Invalid curl option in guzzle_profiler: %s. ' .
